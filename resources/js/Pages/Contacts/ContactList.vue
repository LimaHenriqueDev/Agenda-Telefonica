<template>
  ...
  <div class="container m-auto " style="    min-height: calc(100vh - 144px);">
    ...
    <div class="card mt-5 bg-white border-0">
      <div class="card-body m-3 ">
        <div class="d-flex col-lg-12 flex-column align-items-center justify-content-center  text-center mt-4">
          <h1 class="mb-4">Bem-vindo à Agenda telefônica!</h1>

        </div>
        <div class=" mobile_column d-flex justify-content-between align-items-center">
    ...
    <table class="table table-bordered">
            ...
            <tr v-for="contact in contacts.data" :key="contact.id">
                <td class="text-center align-middle">
                    <img v-if="contact.image" 
                         ...
                         style="max-width: 38px; min-height: 38px;" />
                    <div v-else>
                        <img src="/storage/app/public/pexels-pixabay-47319.jpg" 
        ...
        <nav aria-label="Page navigation example">
          {{ contacts.las_page}} 
            ...
            <li class="page-item"><a class="page-link" :class="{disabled:contacts.current_page === 1}" @click="()=>listContacts(contacts.current_page - 1) ">Voltar</a></li>
            <li v-for="page in contacts.last_page" @click="()=>listContacts(page)" :class="{active:page===contacts.current_page}" class="page-item"><a class="page-link" href="#">{{ page }}</a></li>
            <li class="page-item"><a class="page-link" @click="()=>listContacts(contacts.current_page + 1) " :class="{disabled:contacts.last_page === contacts.current_page}">Próximo</a></li>
          </ul>
        </nav>
      </div>
  ...
  <button type="button" ref="modalButtonDelete" style="display: none !important" data-bs-toggle="modal"
    data-bs-target="#confirmDeleteModal" data-bs-dismiss="modal"></button>


  <div class="modal fade" ref="modalDelete" id="confirmDeleteModal" tabindex="-1"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" @click="deleteContact">Deletar</button>
        </div>
      </div>
    </div>
  </div>
